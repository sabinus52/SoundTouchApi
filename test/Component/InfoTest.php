...
class InfoTest extends TestCase
{
    ...
    public function testConstruct()
    {
        ...
        $response->parseContent('<?xml version="1.0" encoding="UTF-8" ?><info deviceID="ABCD123456"><name>SoundTouch</name><type>SoundTouch</type><margeAccountUUID>12345678</margeAccountUUID>
    ...
    {
        $response = new Response();
        $response->parseContent('<?xml version="1.0" encoding="UTF-8" ?><info deviceID="ABCD123456"></info>');
        $obj = new Info();
        $obj->setResponse($response->getXML());
        $this->assertSame('ABCD123456', $obj->getDeviceID());
